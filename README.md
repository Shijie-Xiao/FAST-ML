...
towards the conditional mean damps out. On Hurricane Flossie (East Pacific,
June 2025), 31 raw GEFS members expand to a 492-member ODE ensemble over the
5-day window:
...
"top 10%" that of the mean of the strongest decile of members. The FAST-ML
mean lands within 8 kt of the observed peak against 26 kt for the FNV3 mean,
and the FAST-ML top decile brackets the observed peak while the FNV3 top
decile falls short of it. Pure FAST overshoots (118 kt mean). The Priscilla
case (EP16 2025, free run) and Hurricane Beryl (2024, from the held-out
season) produce the same set of figures.

![Flossie ensemble](img/ensemble_flossie.png)

*Flossie (EP06 2025), initialised 2025-06-29 12:00 UTC, 492 ODE members vs
the 50-member FNV3 ensemble and the best track. Left: the FAST-ML intensity
ensemble with its mean and top decile. Right: per-member ventilation index.*
...
the 31 raw GEFS members as spaghetti and the IBTrACS best track on top.*
...
each panel zoomed to the track domain. The corresponding Priscilla and Beryl
maps are written alongside these in `results/ensemble/`.*
